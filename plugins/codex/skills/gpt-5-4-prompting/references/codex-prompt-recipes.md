...
In `codex:codex-rescue`, review, diagnosis, planning, research, and audit recipes run with `--read-only`; `--write` is reserved for explicit implementation or change requests.
